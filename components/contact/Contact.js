      ...
      <div className="flex flex-row justify-center gap-10 mt-8">
          ...
          <div className="flex flex-col gap-1 justify-center w-[20em] ">
            <div className="flex flex-row flex-wrap gap-1">
              <input className="rounded text-black w-[100%] md:w-[44%]" placeholder="Name" type="text" name="name" ></input>
              <input className="rounded text-black w-[100%] md:w-fit" placeholder="Email" type="email" name="email"></input>
            </div>
