    ...
    <motion.form
      ...
      <div className="flex flex-col justify-center gap-10 mt-8">
          <div className="flex-col text-lg text-center my-auto hidden lg:flex">
            <span role="call to action">Need a problem solved? Send me a message!</span>
          </div>
            ...
            { !sent ?
              <>
                <div className="flex flex-row flex-wrap justify-between gap-1 lg:gap-0">
                  <input
                    className="text-black w-[100%] lg:w-[45%] h-8"
                    placeholder="Name"
                    type="text"
                    name="name"
                    minLength="2"/>
                  <input
                    className="text-black w-[100%] lg:w-[54%] h-8"
                    placeholder="Email"
                    type="email"
                    name="email"/>
                </div>
